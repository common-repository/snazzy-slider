			...
			<div id="post-body-content">
				...
				<div class="postbox snysldr_admin_sidebar" role="group" aria-label="sidebar">
					...
					<div class="inside">
						...
						<a href="https://wordpress.org/plugins/snazzy-slider" id="snzysldr_admin_help"><?php esc_attr_e('Help', 'snazzy-slider'); ?></a>
						<p class="snzysldr_jcd">&copy; <?php echo date("Y"); ?> <a href="http://www.joshcummingsdesign.com">Josh Cummings Design</a>.</p>
					</div>
				</div>
